    ...
    try {
        ...
        if (response.status === 200) {
            ...
            if (data.status === "success") {
                ...
                console.log('success')
                alert("Sorry!! There was an error during upload. [Network Error]");
            }
        } else {
            alert("Sorry!! There was an error during upload. [Network Error]");
        }
        ...
        console.error(error);
        alert("Sorry!! There was an error during upload.");
    } finally {
...
async function search(query) {
    try {
      ...
      if (!response.ok) {
        throw new Error("Sorry!! We got an Error during the Search.[ Searching failed!! ");
      }
